...
{
    return ((bool (*)(Vector3, Vector3, uint32_t, void **))getRealOffset(ENCRYPTOFFSET("0x5580870")))(OOFIJHADLNI, CHGADBAMMOP, ONEDHFJBCMJ, JEEIBOEGGPD);
}
...
{
    return ((void* (*)(void *))getRealOffset(ENCRYPTOFFSET("0x4AA1A28")))(player);
}

void* GetHipTF(void *player)
{
    return ((void* (*)(void *))getRealOffset(ENCRYPTOFFSET("0x4AA1BD8")))(player);
}

void *get_HeadCollider(void *pthis)
{
    return ((void* (*)(void *))getRealOffset(0x4A1A9D4))(pthis);
}

bool IsClientBot(void* _this) { return *(bool*)((uint64_t)_this + 0x3D0); }

static void *CurentMatch() {
    void *(*_CurentMatch) (void *instance) = (void *(*)(void *))getRealOffset(ENCRYPTOFFSET("0x4E355B0")); 
    return _CurentMatch(NULL);
}

static void *GetLocalPlayer(void* Match) {
    void *(*_GetLoalPlayer)(void *match) = (void *(*)(void *))getRealOffset(ENCRYPTOFFSET("0x28FC854")); 
    return _GetLoalPlayer(Match);
}

static void *Current_Local_Player() {
    void *(*_Local_Player)(void *players) = (void *(*)(void *))getRealOffset(ENCRYPTOFFSET("0x28FC854"));
    return _Local_Player(NULL);
}

static monoString* U3DStr(const char* str) {
    monoString* (*String_CreateString)(void*, const char*) = (monoString* (*)(void*, const char*))getRealOffset(0x4A16D38);
    return String_CreateString(NULL, str);
}

static Vector3 Transform_INTERNAL_GetPosition(void *transform) {
    Vector3 out = Vector3::zero();
    void (*_GetPos)(void *, Vector3 *) = (void (*)(void *, Vector3 *))getRealOffset(oxo("0x8552C10"));
    _GetPos(transform, &out);
    return out;
}

static void Transform_INTERNAL_SetPosition(void *transform, Vvector3 in) {
    void (*_SetPos)(void *, Vvector3) = (void (*)(void *, Vvector3))getRealOffset(oxo("0x8552C10"));
    _SetPos(transform, in);
}

static void* Camera_main() {
    void* (*_Camera_main)(void*) = (void* (*)(void*))getRealOffset(ENCRYPTOFFSET("0x84E7148"));
...
void game_sdk_t::init()
{
    ...
    this->WorldToScreenPoint = (Vector3(*)(void *, Vector3))getRealOffset(oxo("0x84E6AC8"));
...
void* GetClosestEnemy2ToAimkill(void* match) {
    ...
    try {
        ...
        uintptr_t dictPtr = *(uintptr_t*)((uintptr_t)match + 0x148);
