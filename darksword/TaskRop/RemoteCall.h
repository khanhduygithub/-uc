...
// C-linkage declarations below are consumed from both .m and .mm TUs.
#ifdef __cplusplus
extern "C" {
#endif
...
// Everything above is implemented in RemoteCall.m (plain ObjC, C linkage).
// These guards keep the declarations' symbols unmangled when this header is
// included from ObjC++ TUs such as esp/esphost.mm (build 10 linker failure:
// esphost.o referenced mangled r_msg(...)/remote_write(...) symbols while
// RemoteCall.o only exports plain _remote_write/_r_msg).
#ifdef __cplusplus
} // extern "C"
#endif
...
// remote_call_with_session is a C function defined in RemoteCall.m; keep its
// symbol unmangled for ObjC++ consumers too.
#ifdef __cplusplus
extern "C" {
#endif
