...
#import <mach/mach.h>
// NOTE (build 8 fix): <mach/mach_vm_types.h> does not exist in the iOS SDK;
// mach_vm_address_t / mach_vm_size_t resolve through <mach/mach.h> itself.

// iOS SDK ships <mach/mach_vm.h> as an "#error mach_vm.h unsupported." stub,
// but the mach_vm_* symbols are exported by libsystem_kernel.dylib. Declare
// what this file uses (prototypes identical to the macOS SDK's mach_vm.h).
#if defined(__MAC_OS_X_VERSION_MIN_REQUIRED)
#import <mach/mach_vm.h> // real header exists on macOS
#else
