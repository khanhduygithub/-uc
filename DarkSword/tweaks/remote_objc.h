...
// All functions here are implemented in remote_objc.m (plain ObjC, C
// linkage). Without this guard an ObjC++ consumer (esp/esphost.mm) mangles
// every name — build 10 failed to link: esphost.o asked for
// r_msg(char const*, ...) / r_sel(char const*) style symbols while
// remote_objc.o only exports plain _r_msg/_r_sel.
#ifdef __cplusplus
extern "C" {
#endif
